...
-- Q1.Write a SQL query to find the salaries of all employess
-- ANS:
SELECT salary
FROM employees;
...
-- ANS:
SELECT DISTINCT JOB_TITLE AS 'Job Name'
FROM employee.jobs;

-- =======================================================================================================================================

-- Q3.write a SQL query to list the employees name increased their salary by 15% and expressed as numbers and dollars.
-- ANS:
SELECT FIRST_NAME AS 'EMPLOYEE_NAME', SALARY,
 CONCAT('$',FORMAT(1.15*salary,0)) AS "SALARY_IN_DOLLARS"
FROM employees;

-- =======================================================================================================================================

-- Q4.write a SQL query to list the employees name and job name as a format of "Employee's and job". 
-- ANS:
SELECT employees.FIRST_NAME AS "Employee's",jobs.JOB_TITLE  AS "Job"
FROM employees
INNER JOIN jobs ON employees.JOB_ID=jobs.JOB_ID;

-- =======================================================================================================================================

-- Q5.write a SQL query to find those employees with hire date in the format like february 22,1991.return employeeID ,employee name,salary,hiredate.
-- ANS:
SELECT EMPLOYEE_ID,
...
-- Q6.write a SQL query to count the number of characters except the space for each employee name.Return employee name length.
-- ANS:
SELECT length(FIRST_NAME) AS 'FIRST_NAME'
FROM employees;
-- ----------------AND ASLO LAST NAME ---------------------------
SELECT length(LAST_NAME) AS 'LAST_NAME'
FROM employees;
-- =======================================================================================================================================
...
-- ANS:
SELECT DISTINCT DEPARTMENT_ID,jobs.JOB_TITLE  AS "JOB_NAME"
FROM employees
INNER JOIN jobs ON employees.JOB_ID=jobs.JOB_ID;              
...
-- ANS:
SELECT DISTINCT avg(SALARY),jobs.JOB_TITLE  AS "JOB_NAME"
FROM employees
INNER JOIN jobs ON employees.JOB_ID=jobs.JOB_ID
